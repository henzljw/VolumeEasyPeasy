...
//Group Project
//VolumeEasyPeasy - ConeHistory.cs [Content Page (C#)]
...
{
    public class ConeHistory : ContentPage
    {
        ...
        public ConeHistory()
        {
            ...
            historyList.ItemsSource = db.Table<ConeModel>().ToList();
        ...
        private async void Delete_Clicked(object sender, EventArgs e)
        {
            ...
            if (obj.Id != 0)
            {
                ...
                {
                    db.Table<ConeModel>().Delete(x => x.Id == obj.Id);
