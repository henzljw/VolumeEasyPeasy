...
//Group Project
//VolumeEasyPeasy - CubeHistory.cs [Content Page (C#)]
...
{
    public class CubeHistory : ContentPage
    {
        ...
        public CubeHistory()
        {
            ...
            historyList.ItemsSource = db.Table<CubeModel>().ToList();
        ...
        private async void Delete_Clicked(object sender, EventArgs e)
        {
            ...
            if (obj.Id != 0)
            {
                ...
                {
                    db.Table<CubeModel>().Delete(x => x.Id == obj.Id);
