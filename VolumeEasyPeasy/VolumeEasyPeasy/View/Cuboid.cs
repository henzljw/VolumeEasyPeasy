...
//Group Project
//VolumeEasyPeasy - Cuboid.cs [Content Page (C#)]
...
{
    public class Cuboid : ContentPage
    {
        //View declaration
        ...
        private void Equal_Clicked(object sender, EventArgs e)
        {
            ...
            Result.Text = (x * y * z).ToString("00.00");
            //Store data into database
            var db = new SQLiteConnection(dbPath);

            db.CreateTable<CuboidModel>();
        ...
        {
            Navigation.PushAsync(new CuboidHistory());
        }
    }
}