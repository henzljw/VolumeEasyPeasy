...
//Group Project
//VolumeEasyPeasy - Cone.cs [Content Page (C#)]
...
namespace VolumeEasyPeasy.View
{
    public class Cone : ContentPage
    {
        ...
        private void Equal_Clicked(object sender, EventArgs e)
        {
            ...
            Result.Text = (3.142 * x * x * y / 3.0).ToString("00.00");
            //Store data into database
            var db = new SQLiteConnection(dbPath);

            db.CreateTable<ConeModel>();

            ConeModel obj = new ConeModel();
        ...
        {
            Navigation.PushAsync(new ConeHistory());
        }
    }
}