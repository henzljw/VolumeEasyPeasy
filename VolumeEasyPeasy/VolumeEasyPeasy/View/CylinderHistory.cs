...
//Group Project
//VolumeEasyPeasy - CylinderHistory.cs [Content Page (C#)]
...
{
    public class CylinderHistory : ContentPage
    {
        ...
        public CylinderHistory()
        {
            ...
            historyList.ItemsSource = db.Table<CylinderModel>().ToList();
        ...
        private async void Delete_Clicked(object sender, EventArgs e)
        {
            ...
            if (obj.Id != 0)
            {
                ...
                {
                    db.Table<CylinderModel>().Delete(x => x.Id == obj.Id);
