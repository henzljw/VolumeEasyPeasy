...
//Group Project
//VolumeEasyPeasy - Sphere.cs [Content Page (C#)]
...
{
    public class Sphere : ContentPage
    {
        //View declaration
        private Label radiusTitle, resultTitle, Result, formulaTitle;
        private Entry Radius;
        ...
        private void Equal_Clicked(object sender, EventArgs e)
        {
            ...
            Result.Text = ((4.0 / 3.0) * 3.142 * x * x * x).ToString("00.00");
            //Store data into database
            var db = new SQLiteConnection(dbPath);
          
            db.CreateTable<SphereModel>();

            SphereModel obj = new SphereModel();
        ...
        {
            Navigation.PushAsync(new SphereHistory());
        }
    }
}