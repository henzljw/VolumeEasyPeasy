...
//Group Project
//VolumeEasyPeasy - SphereHistory.cs [Content Page (C#)]
...
{
    public class SphereHistory : ContentPage
    {
        ...
        public SphereHistory()
        {
            ...
            historyList.ItemsSource = db.Table<SphereModel>().ToList();
        ...
        private async void Delete_Clicked(object sender, EventArgs e)
        {
            ...
            if(obj.Id != 0)
            {
                ...
                {
                    db.Table<SphereModel>().Delete(x => x.Id == obj.Id);
