...
//Group Project
//VolumeEasyPeasy - CuboidHistory.cs [Content Page (C#)]
...
namespace VolumeEasyPeasy.View
{
    public class CuboidHistory : ContentPage
    {
        ...
        public CuboidHistory()
        {
            ...
            historyList.ItemsSource = db.Table<CuboidModel>().ToList();
        ...
        private async void Delete_Clicked(object sender, EventArgs e)
        {
            ...
            if (obj.Id != 0)
            {
                ...
                {
                    db.Table<CuboidModel>().Delete(x => x.Id == obj.Id);
